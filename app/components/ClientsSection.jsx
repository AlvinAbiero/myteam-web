...
const ClientsSection = () => {
  ...
  return (
    <section className="bg-[#012f34] relative w-full overflow-hidden">
      <div className="py-32 md:py-48 px-12 md:px-16 my-0 mx-auto">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-12 md:mb-16 text-center text-white">
          Some of our clients
        </h2>
          ...
          <div className="relative w-full overflow-hidden">
            ...
            >
              {allLogos.map((logo, index) => (
                <div key={index} className="flex items-center justify-center h-16 md:h-32">
                  <Image
                    src={logo.src}
                    alt={logo.alt}
                    className="w-auto h-full object-contain"
